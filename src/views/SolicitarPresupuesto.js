                ...
                <div className="cardRegister">
                    ...
                    <Form onSubmit={onSubmit} initialValues={{ name: '', email: '', telefono: '', experiencia: '', date: null, country: null, oficio: null }} validate={validate} render={({ handleSubmit }) => (
                        <form onSubmit={handleSubmit} className="p-fluid">
                            ...
                            <Field on name="descripcionPresupuesto" render={({ input, meta }) => (
                                <div className="field">
                                    <span className="p-float-label">
                                        <InputTextarea  id="descripcionPresupuesto" {...input} autoFocus className={classNames({ 'p-invalid': isFormFieldValid(meta) })} />
                                        <label htmlFor="descripcionPresupuesto" className={classNames({ 'p-error': isFormFieldValid(meta) })}> Descripcion del servicio a solicitar (datos de relevancia) </label>
                                    </span>
                                    {getFormErrorMessage(meta)}
                                </div>
                            )} />
