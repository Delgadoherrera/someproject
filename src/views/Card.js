...
export default function CardDemo() {
    ...
    return (
        ...
        <div>
            <Card title="Atencion a obras sociales y centros de rehabilitacion" subTitle="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore sed consequuntur error repudiandae numquam deserunt quisquam repellat
